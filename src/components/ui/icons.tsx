...
// Using SVG icons for better control and no external dependencies

export function BriefcaseIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0v-2.26c0-1.094-.787-2.036-1.872-2.18-2.087-.277-4.216-.42-6.378-.42s-4.291.143-6.378.42c-1.085.144-1.872 1.086-1.872 2.18v2.26m16.5 0c0 1.105-.563 2.067-1.414 2.625M3.75 14.15c0 1.105.563 2.067 1.414 2.625m15.146 0c-1.105 0-2.067-.563-2.625-1.414m0 0c-.467-.772-.75-1.658-.75-2.625m-15 4.664c1.105 0 2.067-.563 2.625-1.414m0 0c.467-.772.75-1.658.75-2.625" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375c0 2.278-3.894 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.894-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.894 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.357 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.894 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
    </svg>
  );
}
...
export function TargetIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 12a9 9 0 11-9-9 9.75 9.75 0 016.74 2.74L12 12z" />
    </svg>
  );
}
...
export function MoreHorizontalIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function ArrowUpDownIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function LoaderIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
...
export function InboxIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859m-19.5 0c0 2.278 3.894 4.125 8.25 4.125s8.25-1.847 8.25-4.125m-19.5 0c0-2.278 3.894-4.125 8.25-4.125s8.25 1.847 8.25 4.125" />
    </svg>
  );
}

export function FileSpreadsheetIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125m-8.625 1.125V5.625m0 12.75v-1.5c0-.621.504-1.125 1.125-1.125m0 0h7.5m-7.5 0h7.5m-7.5 0c-.621 0-1.125.504-1.125 1.125m8.625-1.125c.621 0 1.125.504 1.125 1.125m0 0v1.5m0-1.5c0-.621-.504-1.125-1.125-1.125m0 0h-7.5m-7.5 0c-.621 0-1.125.504-1.125 1.125M15 12h3.75m-3.75 0h-3.75m3.75 0v3.75m0-3.75V8.25m0 3.75V15" />
    </svg>
  );
}
...
export function RotateCcwIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
